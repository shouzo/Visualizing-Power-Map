	...
	public void onCreate(Bundle icicle) {
		...
		View.OnClickListener getImgListener = new View.OnClickListener()
		{
			...
			public void onClick(View view) {
			    ...
			    String uriAPI ="https://maps.googleapis.com/maps/api/distancematrix/json?origins=Taipei&destinations=Kaohsiung&key=AIzaSyBNQORdka1a2XM7TLCwDvR8BSd7DMlntdo";
